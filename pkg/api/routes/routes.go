...
import (
	...
	"github.com/satyamvatstyagi/LinkManagementService/pkg/api/controller"
	"github.com/satyamvatstyagi/LinkManagementService/pkg/api/middlewares"
	"github.com/satyamvatstyagi/LinkManagementService/pkg/app/config"
	"github.com/satyamvatstyagi/LinkManagementService/pkg/app/repository"
	"github.com/satyamvatstyagi/LinkManagementService/pkg/app/usecase"
...
func setupRoutes(router *gin.Engine) {
	...
	userController := &controller.UserController{LinkUsecase: userUsecase}
	...
	userService := router.Group("/user", gin.BasicAuth(gin.Accounts{username: password}))
	{
		...
		userService.GET("/link", middlewares.LoggingMiddleware(logger), userController.GetLinks)
	}
}
